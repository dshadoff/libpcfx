...
#ifndef _LIBERIS_SOUNDBOX_H_
#define _LIBERIS_SOUNDBOX_H_
 ...
 *             n = (3580000 / 32) / freq
 */
void eris_psg_set_freq(u16 freq);
 ...
 */
void eris_psg_set_volume(u8 vol, u8 on, u8 dda);
/*! \brief Set the balance on the active channel.
 * 
 * \param left Left speaker output volume. (0 ~ 15)
 * \param right Right speaker output volume. (0 ~ 15)
 */
void eris_psg_set_balance(u8 left, u8 right);
 ...
 */
void eris_psg_set_noise(u8 freq, u8 enabled);
 ...
 *             documentation.
 */
void eris_psg_set_lfo_control(int on, int ctrl);
 ...
 */
void eris_adpcm_set_control(adpcm_rate rate, u8 ch0_interp, u8 ch1_interp,
 ...
 */
void eris_adpcm_set_volume(u8 chan, u8 left, u8 right);
/*! \brief Set CDDA volume.
 *
 * \param left Left speaker volume. (0 ~ 63)
 * \param right Right speaker volume. (0 ~ 63)
 */
void eris_cdda_set_volume(u8 left, u8 right);
